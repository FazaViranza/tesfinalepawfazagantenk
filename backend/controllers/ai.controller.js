...
const getPrediction = async (req, res, next) => {
  try {
    ...
    const data = await AIPredictionService.getSalesForecast(forecastDays);
...
const getCrossSell = async (req, res, next) => {
  try {
    ...
    const data = await AIRecommendationService.getCrossSellRecommendations(productIds);
    res.json({ success: true, data });
  } catch (err) {
    next(err);
  }
...
const getBusinessInsights = async (req, res, next) => {
  try {
    const data = await AIBusinessInsightService.getBusinessHealthOverview();
    res.json({ success: true, data });
  } catch (err) {
    next(err);
  }
...
const getSavedInsights = async (req, res, next) => {
  try {
    const data = await AIBusinessInsightService.getSavedInsights();
    res.json({ success: true, data });
  } catch (err) {
    next(err);
  }
...
const chatQuery = async (req, res, next) => {
  try {
    ...
    const data = await AIChatAssistantService.handleChatQuery(message);
    res.json({ success: true, data });
  } catch (err) {
    next(err);
  }
